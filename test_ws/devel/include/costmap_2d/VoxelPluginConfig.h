...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(VoxelPluginConfig::AbstractParamDescriptionConstPtr(new VoxelPluginConfig::ParamDescription<int>("combination_method", "int", 0, "Method for combining two layers", "{'enum': [{'name': 'Overwrite', 'type': 'int', 'value': 0, 'srcline': 16, 'srcfile': '/home/kongen/test_ws/src/navigation/costmap_2d/cfg/VoxelPlugin.cfg', 'description': 'Overwrite values', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Maximum', 'type': 'int', 'value': 1, 'srcline': 17, 'srcfile': '/home/kongen/test_ws/src/navigation/costmap_2d/cfg/VoxelPlugin.cfg', 'description': 'Take the maximum of the values', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Nothing', 'type': 'int', 'value': 99, 'srcline': 18, 'srcfile': '/home/kongen/test_ws/src/navigation/costmap_2d/cfg/VoxelPlugin.cfg', 'description': 'Do nothing', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'Method for combining layers enum'}", &VoxelPluginConfig::combination_method)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 16 "/home/kongen/test_ws/src/navigation/costmap_2d/cfg/VoxelPlugin.cfg"
      const int VoxelPlugin_Overwrite = 0;
//#line 17 "/home/kongen/test_ws/src/navigation/costmap_2d/cfg/VoxelPlugin.cfg"
      const int VoxelPlugin_Maximum = 1;
//#line 18 "/home/kongen/test_ws/src/navigation/costmap_2d/cfg/VoxelPlugin.cfg"
