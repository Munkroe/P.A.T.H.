...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(GlobalPlannerConfig::AbstractParamDescriptionConstPtr(new GlobalPlannerConfig::ParamDescription<int>("orientation_mode", "int", 0, "How to set the orientation of each point", "{'enum': [{'name': 'None', 'type': 'int', 'value': 0, 'srcline': 14, 'srcfile': '/home/kongen/test_ws/src/navigation/global_planner/cfg/GlobalPlanner.cfg', 'description': 'No orientations added except goal orientation', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Forward', 'type': 'int', 'value': 1, 'srcline': 15, 'srcfile': '/home/kongen/test_ws/src/navigation/global_planner/cfg/GlobalPlanner.cfg', 'description': 'Positive x axis points along path, except for the goal orientation', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Interpolate', 'type': 'int', 'value': 2, 'srcline': 17, 'srcfile': '/home/kongen/test_ws/src/navigation/global_planner/cfg/GlobalPlanner.cfg', 'description': 'Orientations are a linear blend of start and goal pose', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'ForwardThenInterpolate', 'type': 'int', 'value': 3, 'srcline': 18, 'srcfile': '/home/kongen/test_ws/src/navigation/global_planner/cfg/GlobalPlanner.cfg', 'description': 'Forward orientation until last straightaway, then a linear blend until the goal pose', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Backward', 'type': 'int', 'value': 4, 'srcline': 20, 'srcfile': '/home/kongen/test_ws/src/navigation/global_planner/cfg/GlobalPlanner.cfg', 'description': 'Negative x axis points along the path, except for the goal orientation', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Leftward', 'type': 'int', 'value': 5, 'srcline': 22, 'srcfile': '/home/kongen/test_ws/src/navigation/global_planner/cfg/GlobalPlanner.cfg', 'description': 'Positive y axis points along the path, except for the goal orientation', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Rightward', 'type': 'int', 'value': 6, 'srcline': 24, 'srcfile': '/home/kongen/test_ws/src/navigation/global_planner/cfg/GlobalPlanner.cfg', 'description': 'Negative y axis points along the path, except for the goal orientation', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'How to set the orientation of each point'}", &GlobalPlannerConfig::orientation_mode)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 14 "/home/kongen/test_ws/src/navigation/global_planner/cfg/GlobalPlanner.cfg"
      const int GlobalPlanner_None = 0;
//#line 15 "/home/kongen/test_ws/src/navigation/global_planner/cfg/GlobalPlanner.cfg"
      const int GlobalPlanner_Forward = 1;
//#line 17 "/home/kongen/test_ws/src/navigation/global_planner/cfg/GlobalPlanner.cfg"
      const int GlobalPlanner_Interpolate = 2;
//#line 18 "/home/kongen/test_ws/src/navigation/global_planner/cfg/GlobalPlanner.cfg"
      const int GlobalPlanner_ForwardThenInterpolate = 3;
//#line 20 "/home/kongen/test_ws/src/navigation/global_planner/cfg/GlobalPlanner.cfg"
      const int GlobalPlanner_Backward = 4;
//#line 22 "/home/kongen/test_ws/src/navigation/global_planner/cfg/GlobalPlanner.cfg"
      const int GlobalPlanner_Leftward = 5;
//#line 24 "/home/kongen/test_ws/src/navigation/global_planner/cfg/GlobalPlanner.cfg"
