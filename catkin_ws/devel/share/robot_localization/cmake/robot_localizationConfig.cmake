...
if(NOT "/home/ubuntu/catkin_ws/devel/include;/home/ubuntu/catkin_ws/src/robot_localization/include;/usr/include/eigen3 " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'robot_localization' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/catkin_ws/src/robot_localization/${idir}'.  ${_report}")
    endif()
