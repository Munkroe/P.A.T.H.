...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(AMCLConfig::AbstractParamDescriptionConstPtr(new AMCLConfig::ParamDescription<std::string>("laser_model_type", "str", 0, "Which model to use, either beam, likelihood_field or likelihood_field_prob.", "{'enum': [{'name': 'beam_const', 'type': 'str', 'value': 'beam', 'srcline': 52, 'srcfile': '/home/kongen/test_ws/src/navigation/amcl/cfg/AMCL.cfg', 'description': 'Use beam laser model', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'likelihood_field_const', 'type': 'str', 'value': 'likelihood_field', 'srcline': 52, 'srcfile': '/home/kongen/test_ws/src/navigation/amcl/cfg/AMCL.cfg', 'description': 'Use likelihood_field laser model', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'likelihood_field_prob', 'type': 'str', 'value': 'likelihood_field_prob', 'srcline': 52, 'srcfile': '/home/kongen/test_ws/src/navigation/amcl/cfg/AMCL.cfg', 'description': 'Use likelihood_field_prob laser model', 'ctype': 'std::string', 'cconsttype': 'const char * const'}], 'enum_description': 'Laser Models'}", &AMCLConfig::laser_model_type)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(AMCLConfig::AbstractParamDescriptionConstPtr(new AMCLConfig::ParamDescription<std::string>("laser_model_type", "str", 0, "Which model to use, either beam, likelihood_field or likelihood_field_prob.", "{'enum': [{'name': 'beam_const', 'type': 'str', 'value': 'beam', 'srcline': 52, 'srcfile': '/home/kongen/test_ws/src/navigation/amcl/cfg/AMCL.cfg', 'description': 'Use beam laser model', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'likelihood_field_const', 'type': 'str', 'value': 'likelihood_field', 'srcline': 52, 'srcfile': '/home/kongen/test_ws/src/navigation/amcl/cfg/AMCL.cfg', 'description': 'Use likelihood_field laser model', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'likelihood_field_prob', 'type': 'str', 'value': 'likelihood_field_prob', 'srcline': 52, 'srcfile': '/home/kongen/test_ws/src/navigation/amcl/cfg/AMCL.cfg', 'description': 'Use likelihood_field_prob laser model', 'ctype': 'std::string', 'cconsttype': 'const char * const'}], 'enum_description': 'Laser Models'}", &AMCLConfig::laser_model_type)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(AMCLConfig::AbstractParamDescriptionConstPtr(new AMCLConfig::ParamDescription<std::string>("odom_model_type", "str", 0, "Which model to use, diff, omni, diff-corrected, or omni-corrected", "{'enum': [{'name': 'diff_const', 'type': 'str', 'value': 'diff', 'srcline': 56, 'srcfile': '/home/kongen/test_ws/src/navigation/amcl/cfg/AMCL.cfg', 'description': 'Use diff odom model', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'omni_const', 'type': 'str', 'value': 'omni', 'srcline': 57, 'srcfile': '/home/kongen/test_ws/src/navigation/amcl/cfg/AMCL.cfg', 'description': 'Use omni odom model', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'diff_corrected_const', 'type': 'str', 'value': 'diff-corrected', 'srcline': 58, 'srcfile': '/home/kongen/test_ws/src/navigation/amcl/cfg/AMCL.cfg', 'description': 'Use corrected diff odom model', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'omni_corrected_const', 'type': 'str', 'value': 'omni-corrected', 'srcline': 59, 'srcfile': '/home/kongen/test_ws/src/navigation/amcl/cfg/AMCL.cfg', 'description': 'Use corrected omni odom model', 'ctype': 'std::string', 'cconsttype': 'const char * const'}], 'enum_description': 'Odom Models'}", &AMCLConfig::odom_model_type)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(AMCLConfig::AbstractParamDescriptionConstPtr(new AMCLConfig::ParamDescription<std::string>("odom_model_type", "str", 0, "Which model to use, diff, omni, diff-corrected, or omni-corrected", "{'enum': [{'name': 'diff_const', 'type': 'str', 'value': 'diff', 'srcline': 56, 'srcfile': '/home/kongen/test_ws/src/navigation/amcl/cfg/AMCL.cfg', 'description': 'Use diff odom model', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'omni_const', 'type': 'str', 'value': 'omni', 'srcline': 57, 'srcfile': '/home/kongen/test_ws/src/navigation/amcl/cfg/AMCL.cfg', 'description': 'Use omni odom model', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'diff_corrected_const', 'type': 'str', 'value': 'diff-corrected', 'srcline': 58, 'srcfile': '/home/kongen/test_ws/src/navigation/amcl/cfg/AMCL.cfg', 'description': 'Use corrected diff odom model', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'omni_corrected_const', 'type': 'str', 'value': 'omni-corrected', 'srcline': 59, 'srcfile': '/home/kongen/test_ws/src/navigation/amcl/cfg/AMCL.cfg', 'description': 'Use corrected omni odom model', 'ctype': 'std::string', 'cconsttype': 'const char * const'}], 'enum_description': 'Odom Models'}", &AMCLConfig::odom_model_type)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 52 "/home/kongen/test_ws/src/navigation/amcl/cfg/AMCL.cfg"
...
//#line 56 "/home/kongen/test_ws/src/navigation/amcl/cfg/AMCL.cfg"
      const char * const AMCL_diff_const = "diff";
//#line 57 "/home/kongen/test_ws/src/navigation/amcl/cfg/AMCL.cfg"
      const char * const AMCL_omni_const = "omni";
//#line 58 "/home/kongen/test_ws/src/navigation/amcl/cfg/AMCL.cfg"
      const char * const AMCL_diff_corrected_const = "diff-corrected";
//#line 59 "/home/kongen/test_ws/src/navigation/amcl/cfg/AMCL.cfg"
